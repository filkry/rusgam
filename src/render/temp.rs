...
impl super::SRender {
    pub fn render_temp_in_world(&mut self, render_frame_context: &super::SRenderFrameContext, view_matrix: &Mat4) -> Result<(), &'static str> {
        self.render_temp_points(render_frame_context, view_matrix, true)?;
        self.render_temp_lines(render_frame_context, view_matrix, true)?;
        self.render_temp_spheres(render_frame_context, view_matrix, true)?;
        self.render_temp_models(render_frame_context, view_matrix, true)?;

        Ok(())
    }

    pub fn render_temp_over_world(&mut self, render_frame_context: &super::SRenderFrameContext, view_matrix: &Mat4) -> Result<(), &'static str> {
        self.render_temp_points(render_frame_context, view_matrix, false)?;
        self.render_temp_lines(render_frame_context, view_matrix, false)?;
        self.render_temp_spheres(render_frame_context, view_matrix, false)?;
        self.render_temp_models(render_frame_context, view_matrix, false)?;
